document.addEventListener("DOMContentLoaded", function () {
  ...
  var regiontextLayer = L.imageOverlay('../../assets/img/trusk/region_text_ZH.png', regiontextBounds);

  //生态图
  var ecoBounds = [[2700, 0], [0, 4800]];
  var ecoLayer = L.imageOverlay('../../assets/img/trusk/eco.png', ecoBounds);

  //疆界图
  var borderBounds = [[2150, 1140], [50, 4750]];
  var borderLayer = L.imageOverlay('../../assets/img/trusk/border_trusk.png', borderBounds);

  //地理名称
  var geotextBounds = [[2500, 1500], [200, 3600]];
  var geotextLayer = L.imageOverlay('../../assets/img/trusk/geo_text_ZH.png', geotextBounds);
