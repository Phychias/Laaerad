document.addEventListener("DOMContentLoaded", function () {
  ...
  var baseLayer = L.imageOverlay('../img/trusk_map/trusk_render.png', bounds);
  var baseLayer_white = L.imageOverlay('../img/trusk_map/trusk_render_white.png', bounds);

  //行政区图
  var regionBounds = [[2200, 1900], [200, 3400]];
  var regionLayer = L.imageOverlay('../img/trusk_map/region.png', regionBounds);
  var regiontextBounds = [[2100, 1900], [300, 3300]];
  var regiontextLayer = L.imageOverlay('../img/trusk_map/region_text_ZH.png', regiontextBounds);

  //生态图
  var ecoBounds = [[2700, 0], [0, 4800]];
  var ecoLayer = L.imageOverlay('../img/trusk_map/eco.png', ecoBounds);

  //疆界图
  var borderBounds = [[2150, 1140], [50, 4750]];
  var borderLayer = L.imageOverlay('../img/trusk_map/border_trusk.png', borderBounds);

  //地理名称
  var geotextBounds = [[2500, 1500], [200, 3600]];
  var geotextLayer = L.imageOverlay('../img/trusk_map/geo_text_ZH.png', geotextBounds);
